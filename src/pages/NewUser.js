    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields((err, values) => {
          if (!err) {
            ...
            // console.log('values username: ', JSON.parse(localStorage.getItem('saveData'+localStorage.id))['username']);
            // console.log('values1: ',localStorage.getItem('saveData'+localStorage.id));
